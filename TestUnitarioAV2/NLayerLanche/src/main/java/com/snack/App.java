...
public class App {
    ...
    private static com.snack.services.ProductService productService;
    ...
    public static void resolveDependencies() {
        ...
        productService = new com.snack.services.ProductService();
    ...
    public static void initializeProducts() {
        Product product1 = new Product(1, "Hotdog", 4.00f, "src/main/resources/imagens/HotDog.jpg");
